...
public class Robot {
	 ...
	 * 
	 * @param behaviour governs selection of mail items for delivery and behaviour
	 *                  on priority arrivals
	 ...
	 * 
	 * @throws ExcessiveDeliveryException if robot delivers more than the capacity
	 *                                    of the tube without refilling
	 */
	...
	public void addToHand(MailItem mailItem) throws ItemTooHeavyException {
		...
		if (mailItem.weight > INDIVIDUAL_MAX_WEIGHT)
